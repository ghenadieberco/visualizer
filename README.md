...
- **Controls:** a collapsible right-hand panel for preset selection, zoom (30%–600%), mic on/off, and live signal meters. Keyboard: `H` panel, `F` fullscreen, `1`–`7` presets, arrows next/prev, `+` / `-` / `0` zoom.
